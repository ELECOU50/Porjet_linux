...
sous_menu1() {
    ...
    while true; do
	    ...
	    2) dialog --clear --msgbox "Les vaisseaux sont des structures capables, après un certain nombre de générations, de produire une copie d’elles-mêmes, mais décalées dans l’univers du jeu." "25" "45"
	       sous_menu1 ;;
            3) break ;;
